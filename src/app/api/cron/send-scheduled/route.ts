...
// Was 10. With SEND_SCHEDULED_BATCH × ~1.5s SMTP + inter-send delays
// (default 5s), the loop routinely exceeds 10s. Vercel killed mid-loop
// and (before the finally below) leaked the lock for the full stale TTL.
