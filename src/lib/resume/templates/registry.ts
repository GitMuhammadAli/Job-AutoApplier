...
export const TEMPLATE_REGISTRY: readonly TemplateRegistryEntry[] = [
  ...
  },
  {
    ...
    version: "T05@1.0.0",
    name: "Executive Bold",
    description: "Instrument Serif name treatment, less density, executive presence.",
  ...
  },
  {
    ...
    description: "Manrope + Inter. No rules, generous whitespace, sentence-case headers.",
  ...
  },
  {
    ...
    description: "Satoshi + Inter, emerald accent underline on section headers.",
  ...
  },
  {
    ...
    version: "T10@1.0.0",
    name: "Senior IC",
    description: "JetBrains Mono section headers, dense leading, technical depth.",
  ...
  // ── TWO-COLUMN (visual-leaning roles, 4 entries) ────────────────────
  {
    ...
    version: "T11@1.0.0",
    name: "Sidebar Skills",
    description: "Neutral light sidebar (contact + skills + education). Main: summary + experience + projects.",
  ...
  },
  {
    ...
    description: "Dark sidebar + emerald accent stripe between columns. Plus Jakarta Sans.",
  ...
  },
  {
    ...
    version: "T13@1.0.0",
    name: "PM Timeline",
    description: "Light zinc sidebar, dates prominent, achievement-led main column.",
  ...
  },
  {
    ...
    description: "Amber sidebar + accent stripe, KPI-driven layout.",
  ...
  },
  {
    ...
    description: "Times New Roman, no flourish, no web fonts. Maximally parser-friendly.",
