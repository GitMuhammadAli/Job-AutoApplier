  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <Link
          href={`/jobs/${job.id}`}
          className="text-xs font-semibold text-slate-800 dark:text-zinc-100 hover:text-blue-600 dark:hover:text-blue-400 truncate block"
        >
          {g.title}
        </Link>
        <div className="flex items-center gap-1.5 text-[10px] text-slate-500 dark:text-zinc-400">
          ...
          {reason && (
            <>
              <span className="text-slate-300 dark:text-zinc-600">&middot;</span>
              <span className="truncate text-blue-500 dark:text-blue-400">{reason}</span>
            </>
          )}
        </div>
      </div>
      ...
      {isApplied ? (
        ...
        <Link href={`/jobs/${job.id}?apply=true`}>
          <Button size="sm" variant="outline" className="h-7 px-2.5 text-[10px] gap-1 shrink-0">
        ...
        <Button
          size="sm"
          className="h-7 px-2.5 text-[10px] gap-1 bg-blue-600 hover:bg-blue-700 text-white shrink-0"
