      ...
      <div className="relative mx-auto max-w-4xl px-6">
        ...
        <div className="mt-10 grid sm:grid-cols-2 gap-4">
          {SELLING_POINTS.map((point, i) => (
            <AnimateOnScroll key={i} delay={i * 120} variant={i % 2 === 0 ? "fade-left" : "fade-right"}>
              <div className="group flex items-start gap-3 rounded-xl bg-white dark:bg-zinc-900/60 p-4 ring-1 ring-emerald-100 dark:ring-emerald-900/30 hover:ring-emerald-300 dark:hover:ring-emerald-700/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-emerald-500/5">
                <svg className="h-5 w-5 text-emerald-500 flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
