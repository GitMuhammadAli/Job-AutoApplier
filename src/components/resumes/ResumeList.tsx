...
export function ResumeList({ resumes }: ResumeListProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Re-parse banner — shown when any resume has an uploaded file */}
      {resumesWithFiles.length > 0 && (
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              <p className="text-xs font-semibold text-amber-700 dark:text-amber-300">
                Improved resume parsing available
              </p>
              <p className="text-[10px] text-amber-600/80 dark:text-amber-400/80 mt-0.5 leading-relaxed">
                We&apos;ve upgraded our PDF parser for better text extraction
                and skill detection. Click &quot;Re-parse PDF&quot; on any
                resume below to refresh your content and skills.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {r.fileUrl && (
                    <Button
                      variant="outline"
                      size="sm"
                      className="h-7 text-[10px] px-2 border-amber-300 dark:border-amber-600 text-amber-700 dark:text-amber-300 hover:bg-amber-50 dark:hover:bg-amber-900/30"
                    ...
                    >
                      ...
                      {reExtracting === r.id ? "Parsing..." : "Re-parse PDF"}
                    </Button>
                  )}
                  <Button
                    variant="outline"
