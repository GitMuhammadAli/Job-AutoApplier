...
export function JobForm() {
  ...
  return (
    <div className="max-w-2xl space-y-5">
      <div className="rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-100/80 space-y-4">
        ...
        <div>
          <Label className="text-xs font-medium text-slate-600 mb-1.5">Job Description</Label>
          <Textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Paste the job description..." rows={4} />
        </div>

        <div>
          <Label className="text-xs font-medium text-slate-600 mb-1.5">Notes</Label>
